...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-[color,box-shadow] disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 disabled:text-neutral-300 border border-neutral-200 shadow-sm [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        primary:
          "bg-gradient-to-b from-gray-800 to-gray-900 text-primary-foreground hover:from-gray-900 hover:to-black cursor-pointer",
        destructive:
          "bg-gradient-to-b from-amber-600 to-amber-700 text-primary-foreground hover:from-amber-700 hover:to-amber-700 cursor-pointer",
        outline:
        ...
        ghost: "border-transparent shadow-none hover:bg-accent hover:text-accent-foreground cursor-pointer",
        muted: "bg-neutral-200 text-neutral-600 hover:bg-neutral-200/80 cursor-pointer",
        teritary: "bg-gray-100 text-gray-600 border-transparent shadow-none hover:bg-gray-200 cursor-pointer"
      },
      size: {
